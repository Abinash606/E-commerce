...
import ShoesList from "./ShoesList"; // Importing the ProductList component
          ...
          <Grid item xs={12} md={6}>
            <Box sx={{ marginLeft: 10 }}>
              ...
              <Typography sx={{ marginTop: 2, color: "gray" }}>
                Discover fantastic discounts in our men's designer shoes
                collection. Whether you're after a new pair of Balenciaga for
                work, you'll find it in our men's footwear edit. Explore the
                full men's designer shoes sale to shop leather
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={6}>
            <Box display="flex" justifyContent="center">
              {images.length > 0 ? (
                <StyledImage src={images[7].imageUrl} alt={images[0].name} />
              ) : (
