        ...
        <Grid container spacing={3} alignItems="center">
          <Grid item xs={12} md={6}>
            <Box sx={{ marginLeft: 10 }}>
              ...
              <Typography sx={{ marginTop: 2, color: "gray" }}>
                Complete your look with our sale collection of men's designer
                accessories; from a variety of from labels like Saint Laurent,
                Bottega Veneta and Gucci, to printed leather ,wallets and
                cardholders
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={6}>
            <Box display="flex" justifyContent="center">
              {images.length > 0 ? (
                <StyledImage src={images[0].imageUrl} alt={images[0].name} />
              ) : (
