    ...
    <Box sx={{ width: "100%", padding: "20px", boxSizing: "border-box" }}>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between" }}>
        <Box sx={{ flex: "0 0 40%", padding: "10px" }}>
          <Box sx={{ display: "flex", flexWrap: "wrap" }}>
            <Box sx={{ flex: "0 0 50%", padding: "10px" }}>
              <TaxonLink>All Designers</TaxonLink>
              <TaxonLink>Acne Studios</TaxonLink>
              <TaxonLink>Canali</TaxonLink>
              <TaxonLink>Dunhill</TaxonLink>
              <TaxonLink>Dolce & Gabbana</TaxonLink>
            </Box>
            <Box sx={{ flex: "0 0 50%", padding: "10px" }}>
              <TaxonLink>Missoni</TaxonLink>
              <TaxonLink>Montblanc</TaxonLink>
        ...
        {loading ? (
          ...
          images.slice(4, 6).map((product, index) => (
            <Box
              key={index}
              sx={{
                flex: "0 0 30%",
