        ...
        <Box sx={{ flex: "0 0 40%", padding: "10px" }}>
          <Box sx={{ display: "flex", flexWrap: "wrap" }}>
            <Box sx={{ flex: "0 0 50%", padding: "10px" }}>
              <TaxonLink>All Accessories </TaxonLink>
              <TaxonLink>Bags</TaxonLink>
              <TaxonLink>Wallets</TaxonLink>
              <TaxonLink>Scarves & Ties</TaxonLink>
              <TaxonLink>Belts</TaxonLink>
            </Box>
            <Box sx={{ flex: "0 0 50%", padding: "10px" }}>
              <TaxonLink>Gifts For Him</TaxonLink>
              <TaxonLink>Backpacks</TaxonLink>
              <TaxonLink>Luggage & Travel</TaxonLink>
              <TaxonLink>Tote Bags</TaxonLink>
              <TaxonLink>Pouches</TaxonLink>
            </Box>
          </Box>
        </Box>
        {loading ? (
          ...
          images.slice(2, 4).map((product, index) => (
            <Box
              key={index}
              sx={{
                flex: "0 0 30%",
